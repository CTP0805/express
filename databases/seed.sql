...
(1, 5, 25, '倫敦經典大笨鐘、倫敦眼旅拍', '由專業攝影師帶領，在倫敦經典街區捕捉自然生動的人像。走訪大笨鐘、紅色電話亭與泰晤士河畔等代表性場景。攝影師會提供簡單易懂的姿勢與取景指導，即使第一次拍攝也能自在入鏡。行程結束後將獲得精選調色照片，留下專屬於你的倫敦旅行回憶。', 'Westminster Station 1 號出口', '倫敦', -0.124625, 51.500729, '2026-07-13 12:05:00'),
...
(17, 4, 19, '倫敦泰晤士河健走與探索大笨鐘', '沿著泰晤士河步行欣賞倫敦眼、大笨鐘與河岸風景。導覽員會分享河畔地標與倫敦城市發展的有趣故事。路線安排平緩好走，也會保留時間讓旅人拍照休息。適合喜歡輕鬆散步並認識倫敦經典景點的旅人。', 'London Eye 入口前', '倫敦', -0.119500, 51.503300, '2026-07-21 18:43:34'),
...
(52, 4, 19, '大笨鐘、倫敦眼夜景散步之旅', '沿著泰晤士河畔展開黃昏散步，欣賞倫敦眼與大笨鐘逐漸亮起的夜景。帶領你尋找適合拍照的河岸視角。途中會分享城市地標背後的小故事。適合喜歡夜景與慢旅行的人。', 'Westminster Bridge 北端', '倫敦', -0.121819, 51.500729, '2026-07-23 09:25:43'),
...
-- 展示用：體驗 1 的 8/6、8/7 場次各已有 5 位已付款且確認的旅人
...
SELECT
  'DEMO8601', 1, '測試旅人', '0900000001', 'demo8601@example.com',
  'credit_card', 'paid', adult_price * 5, NULL,
  0, 0, adult_price * 5, 0
FROM sessions
WHERE id = 6101
...
SELECT
  'DEMO8701', 1, '測試旅人', '0900000001', 'demo8701@example.com',
  'credit_card', 'paid', adult_price * 5, NULL,
  0, 0, adult_price * 5, 0
FROM sessions
WHERE id = 6301;
...
INSERT INTO order_items (
  order_id, experience_id, session_id, original_unit_price,
  quantity, subtotal, item_status, special_request
)
SELECT
  'DEMO8601', 1, id, adult_price, 5, adult_price * 5,
  'confirmed', '展示剩餘名額：8/6 場次已有 5 人報名'
FROM sessions
WHERE id = 6101
...
SELECT
  'DEMO8701', 1, id, adult_price, 5, adult_price * 5,
  'confirmed', '展示剩餘名額：8/7 場次已有 5 人報名'
FROM sessions
WHERE id = 6301;
...
(1, 253, 1, 18, 5, '原本很怕自己面對鏡頭會尷尬，但Emily會一步一步引導姿勢，完全不用擔心不知道手要放哪裡。倫敦眼和泰晤士河邊的照片都很自然，成品比想像中更喜歡。', '2026-07-09 12:00:00', NULL),
(2, 353, 1, 29, 5, '兩小時的路線安排得很順，Emily不只帶熱門打卡點，也帶我們找到幾個背景很乾淨的角落。Emily很會抓光線，陰天拍起來反而很有倫敦的氛圍。', '2026-06-17 12:00:00', NULL),
(3, 453, 1, 40, 5, '和朋友第一次到倫敦，想留一組不像觀光客自拍的照片，Emily這個體驗很推薦。大笨鐘、紅色電話亭和河岸都有拍到，Emily也會配合我們想要的感覺調整構圖。', '2026-06-18 12:00:00', NULL),
(4, 553, 1, 51, 5, 'Emily人很親切，中文溝通沒有問題，也會用簡單方式說明拍攝方向。過程不會一直趕行程，讓我們有時間好好欣賞街景，拍照也很放鬆。', '2026-07-10 12:00:00', NULL),
(5, 653, 1, 2, 5, '本來只是想拍幾張紀念照，最後收到Emily的精選照片很驚喜。Emily人物和背景比例抓得很好，連平常不太上相的我都覺得照片很自然。', '2026-06-16 12:00:00', NULL),
(6, 753, 1, 13, 5, '很適合觀光客參加的體驗！Emily不會要求太刻意的互動，而是讓大家邊走邊聊天、自然捕捉瞬間。夜晚街景那一組照片特別有電影感。', '2026-07-17 12:00:00', NULL),
(7, 853, 1, 24, 5, '路線涵蓋了幾個經典地標，但不會像趕行程一樣疲累。Emily對附近環境很熟，知道什麼時間、什麼角度比較好拍，省下我們自己找拍攝地點的時間。', '2026-06-18 12:00:00', NULL),
(8, 953, 1, 35, 5, '我是一個人旅行，原本有點猶豫要不要報名，實際參加後覺得非常值得。有Emily幫忙記錄旅程真的差很多，也讓我留下不少自然、不像擺拍的倫敦照片。', '2026-06-19 12:00:00', NULL),
(9, 1103, 1, 46, 5, 'Emily會先詢問想拍半身、人像還是帶景的照片，這點很貼心。拍攝過程中也會即時讓我們看幾張成品，方便調整表情和角度，整體很專業。', '2026-07-06 12:00:00', NULL),
(10, 1203, 1, 57, 5, 'Emily照片色調很乾淨，保留了倫敦街景原本的質感，不會過度修圖。從拍攝前的溝通到收到照片都很順利，是這次倫敦旅行中很值得的安排。', '2026-06-17 12:00:00', NULL),
...
-- 新增評價圖片
INSERT INTO experience_review_images (review_id, image_url, sort_order)
VALUES
-- 評價 1
(1, '/review-images/review-1/1.png', 0),
(1, '/review-images/review-1/2.png', 1),
(1, '/review-images/review-1/3.png', 2),
(1, '/review-images/review-1/4.png', 3),
(1, '/review-images/review-1/5.png', 4),
(1, '/review-images/review-1/6.png', 5),

-- 評價 2
(2, '/review-images/review-2/1.png', 0),
(2, '/review-images/review-2/2.png', 1),
(2, '/review-images/review-2/3.png', 2),
(2, '/review-images/review-2/4.png', 3),
(2, '/review-images/review-2/5.png', 4),

-- 評價 3
(3, '/review-images/review-3/1.jpg', 0),
(3, '/review-images/review-3/2.jpg', 1),
(3, '/review-images/review-3/3.jpg', 2),
(3, '/review-images/review-3/4.jpg', 3),
(3, '/review-images/review-3/5.jpg', 4),
(3, '/review-images/review-3/6.jpg', 5),

-- 評價 4
(4, '/review-images/review-4/1.jpg', 0),
(4, '/review-images/review-4/2.jpg', 1),
(4, '/review-images/review-4/3.jpg', 2),
(4, '/review-images/review-4/4.jpg', 3),
(4, '/review-images/review-4/5.jpg', 4),

-- 評價 5
(5, '/review-images/review-5/1.jpg', 0),
(5, '/review-images/review-5/2.jpg', 1),
(5, '/review-images/review-5/3.jpg', 2),
(5, '/review-images/review-5/4.jpg', 3),
(5, '/review-images/review-5/5.jpg', 4),
(5, '/review-images/review-5/6.jpg', 5),

-- 評價 6
(6, '/review-images/review-6/1.jpg', 0),
(6, '/review-images/review-6/2.jpg', 1),
(6, '/review-images/review-6/3.jpg', 2),
(6, '/review-images/review-6/4.jpg', 3),
(6, '/review-images/review-6/5.jpg', 4),
(6, '/review-images/review-6/6.jpg', 5),

-- 評價 7
(7, '/review-images/review-7/1.jpg', 0),
(7, '/review-images/review-7/2.jpg', 1),
(7, '/review-images/review-7/3.jpg', 2),
(7, '/review-images/review-7/4.jpg', 3),
(7, '/review-images/review-7/5.jpg', 4),

-- 評價 8
(8, '/review-images/review-8/1.jpg', 0),
(8, '/review-images/review-8/2.jpg', 1),
(8, '/review-images/review-8/3.jpg', 2),
(8, '/review-images/review-8/4.jpg', 3),
(8, '/review-images/review-8/5.jpg', 4),
(8, '/review-images/review-8/6.jpg', 5),

-- 評價 9
(9, '/review-images/review-9/1.jpg', 0),
(9, '/review-images/review-9/2.jpg', 1),
(9, '/review-images/review-9/3.jpg', 2),
(9, '/review-images/review-9/4.jpg', 3),
(9, '/review-images/review-9/5.jpg', 4),

-- 評價 10
(10, '/review-images/review-10/1.jpg', 0),
(10, '/review-images/review-10/2.jpg', 1),
(10, '/review-images/review-10/3.jpg', 2),
(10, '/review-images/review-10/4.jpg', 3),
(10, '/review-images/review-10/5.jpg', 4),
(10, '/review-images/review-10/6.jpg', 5);
